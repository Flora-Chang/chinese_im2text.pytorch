...
def ai_challenger_preprocess():
    ...
    for a in annots:
        imgid = a['image_id']
        if not imgid in itoa: itoa[imgid] = a
        else:
            print("one image two annotations")
        #itoa[imgid].append(a)
        """modified by ffz"""
    ...
    output_file = os.path.join('../data/ai_challenger', 'coco_ai_challenger_raw.json')
    json.dump(out, open(output_file, 'w'))

if __name__ == "__main__":
    train_caption_json = '../data/ai_challenger/ai_challenger_caption_train_20170902/caption_train_annotations_20170902.json'
    train_img_dir = '../data/ai_challenger/ai_challenger_caption_train_20170902/caption_train_images_20170902'
    val_caption_json = '../data/ai_challenger/ai_challenger_caption_validation_20170910/caption_validation_annotations_20170910.json'
    val_img_dir = '../data/ai_challenger/ai_challenger_caption_validation_20170910/caption_validation_images_20170910'
    test_img_dir = '../data/ai_challenger/ai_challenger_caption_test1_20170923/caption_test1_images_20170923'
